...
public class TeleporterDragonDen extends Teleporter {
    ...
    public TeleporterDragonDen(WorldServer par1WorldServer) {
            ...
            for (int l = -2; l <= 2; ++l) {
                for (int i1 = -2; i1 <= 2; ++i1) {
                    for (int j1 = -1; j1 < 3; ++j1) {
                        ...
                        /** change this block **/
                        this.worldServerInstance.setBlock(k1, l1, i2, flag ? Block.blockGold.blockID : 0);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
            ...
            for (k1 = l - short1; k1 <= l + short1; ++k1) {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
                    ...
                    for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
                        /** change this block **/
                        if (this.worldServerInstance.getBlockId(k1, i2, l1) == Blocks.dragonPortal.get().blockID) {
                            /** change this block **/
                            while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == Blocks.dragonPortal.get().blockID) {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D) {
            if (flag) {
                this.destinationCoordinateCache.add(j1, new DragonPortalPosition(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            int j2 = -1;
            /** change this block **/
            if (this.worldServerInstance.getBlockId(i - 1, j, k) == Blocks.dragonPortal.get().blockID) {
                j2 = 2;
            }
            /** change this block **/
            if (this.worldServerInstance.getBlockId(i + 1, j, k) == Blocks.dragonPortal.get().blockID) {
            ...
            /** change this block **/
            if (this.worldServerInstance.getBlockId(i, j, k - 1) == Blocks.dragonPortal.get().blockID) {
                j2 = 3;
            }
            /** change this block **/
            if (this.worldServerInstance.getBlockId(i, j, k + 1) == Blocks.dragonPortal.get().blockID) {
            ...
            for (k2 = -1; k2 <= 1; ++k2) {
                for (i3 = 1; i3 < 3; ++i3) {
                    for (l2 = -1; l2 < 3; ++l2) {
                        ...
                        /** change this block **/
                        this.worldServerInstance.setBlock(k3, j3, i4, flag ? Block.blockGold.blockID : 0);
                    }
                }
            }
        }
        for (k2 = 0; k2 < 4; ++k2) {
            for (i3 = 0; i3 < 4; ++i3) {
                for (l2 = -1; l2 < 4; ++l2) {
                    ...
                    /** change these blocks **/
                    this.worldServerInstance.setBlock(k3, j3, i4, flag ? Block.blockGold.blockID : Blocks.dragonPortal.get().blockID, 0, 2);
                }
            }
            for (i3 = 0; i3 < 4; ++i3) {
                for (l2 = -1; l2 < 4; ++l2) {
