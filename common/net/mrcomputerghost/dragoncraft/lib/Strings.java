package common.net.mrcomputerghost.dragoncraft.lib;
...
public class Strings {
    ...
    public static final String INVALID_FINGERPRINT_MESSAGE = "The copy of DragonCraft that you are running has been modified from the original, and unpredictable things may happen. Please consider re-downloading the original version of the mod.";
    ...
    public static final String DRAGONPORTAL_NAME = "dragonPortal";
